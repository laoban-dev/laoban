...
import { emptyFileOps } from "@laoban/fileops";

describe ( 'postProcessTurnPackageJsonIntoTemplate', () => {
  it ( 'should add variables to the packageJson - empty', async () => {
    const actual = await postProcessTurnPackageJsonIntoTemplate ( 'someContext', emptyFileOps, {}, { file: 'whocares' } ) (
  ...
  it ( 'should return undefined if filecmd is not turnIntoPackageJsonTemplate', async () => {
    const actual = await postProcessTurnPackageJsonIntoTemplate ( 'someContext', emptyFileOps, {}, { file: 'whocares' } ) ( 'text', 'notTurnIntoPackageJsonTemplate' )
