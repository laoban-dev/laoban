...
export type ExecuteOneScriptDecorator = (e: ExecuteOneScript) => ExecuteOneScript
...
export function defaultExecutor(a: AppendToFileIf) { return make(execInShell, execJS, timeIt, ExecuteOneDecorators.normalDecorator(a))}
